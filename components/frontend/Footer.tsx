...
const Footer = () => {
    return (
        <footer className='w-full bg-white dark:bg-black border-t p-4'>
            <Link href={"https://next-feed-black.vercel.app/u/quizzconnect"} className='text-blue-500 hover:text-blue-900 hover:underline underline-offset-4 text-xs font-normal float-right whitespace-nowrap'>
